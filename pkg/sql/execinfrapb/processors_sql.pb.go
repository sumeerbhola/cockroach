...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{0}
}
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{12, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{12, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{15, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{15, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{15, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{15, 1, 2}
}
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{1}
}
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{2}
}
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{3}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{4}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{5}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{6}
}
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{7}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{8}
}
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{9}
}
...
func (*InvertedJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{10}
}
...
type InvertedFiltererSpec struct {
	...
	// First way of passing stuff in spec.
	PreFilterRelationship          *int32                                `protobuf:"varint,3,opt,name=pre_filter_relationship,json=preFilterRelationship" json:"pre_filter_relationship,omitempty"`
	PreFilterBindDatum             *Expression                           `protobuf:"bytes,4,opt,name=pre_filter_bind_datum,json=preFilterBindDatum" json:"pre_filter_bind_datum,omitempty"`
	PreFilterAdditionalParamDatums []*Expression                         `protobuf:"bytes,5,rep,name=pre_filter_additional_param_datums,json=preFilterAdditionalParamDatums" json:"pre_filter_additional_param_datums,omitempty"`
...
func (*InvertedFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{11}
}
...
// Second way of passing stuff in spec.
// Optional pre-filtering expression. @1 refers to column with the inverted index.
...
func (*InvertedFiltererSpec_PreFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{11, 0}
}
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{12}
}
...
func (*InterleavedReaderJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{13}
}
...
func (*InterleavedReaderJoinerSpec_Table) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{13, 0}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{14}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{15}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{15, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_4adf4cb37a910396, []int{15, 2}
}
...
func (m *InvertedFiltererSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i += n22
	if m.PreFilterRelationship != nil {
		dAtA[i] = 0x18
		i++
		i = encodeVarintProcessorsSql(dAtA, i, uint64(*m.PreFilterRelationship))
	}
	if m.PreFilterBindDatum != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintProcessorsSql(dAtA, i, uint64(m.PreFilterBindDatum.Size()))
		n23, err := m.PreFilterBindDatum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
	}
	if len(m.PreFilterAdditionalParamDatums) > 0 {
		for _, msg := range m.PreFilterAdditionalParamDatums {
			dAtA[i] = 0x2a
			i++
			i = encodeVarintProcessorsSql(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *InterleavedReaderJoinerSpec_Table) MarshalTo(dAtA []byte) (int, error) {
	...
	n32, err := m.Desc.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n32
	...
	n33, err := m.Post.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n33
...
func (m *InvertedFiltererSpec) Size() (n int) {
	...
	n += 1 + l + sovProcessorsSql(uint64(l))
	if m.PreFilterRelationship != nil {
		n += 1 + sovProcessorsSql(uint64(*m.PreFilterRelationship))
	}
	if m.PreFilterBindDatum != nil {
		l = m.PreFilterBindDatum.Size()
		n += 1 + l + sovProcessorsSql(uint64(l))
	}
	if len(m.PreFilterAdditionalParamDatums) > 0 {
		for _, e := range m.PreFilterAdditionalParamDatums {
			l = e.Size()
			n += 1 + l + sovProcessorsSql(uint64(l))
		}
	}
...
func (m *InvertedFiltererSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreFilterRelationship", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PreFilterRelationship = &v
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreFilterBindDatum", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PreFilterBindDatum == nil {
				m.PreFilterBindDatum = &Expression{}
			}
			if err := m.PreFilterBindDatum.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreFilterAdditionalParamDatums", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PreFilterAdditionalParamDatums = append(m.PreFilterAdditionalParamDatums, &Expression{})
			if err := m.PreFilterAdditionalParamDatums[len(m.PreFilterAdditionalParamDatums)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_sql.proto", fileDescriptor_processors_sql_4adf4cb37a910396)
}

var fileDescriptor_processors_sql_4adf4cb37a910396 = []byte{
	...
	,
}
