...
# #roachprod create -n 5 $clus
roachprod wipe $clus

# roachprod create -n 7 local
# roachprod wipe $clus
# roachprod stop $clus:1-7 || true
roachprod put $clus ./cockroach-linux-2.6.32-gnu-amd64 ./cockroach

roachprod start $clus:1-5
...
# #roachprod run $clus:1 -- ./cockroach workload fixtures import tpcc --warehouses=1000 --checks=false

roachprod run $clus:1 -- ./cockroach workload init tpcc --warehouses=500
