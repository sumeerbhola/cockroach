...
type Writer interface {
	...
	// PutRaw is a low-level interface for users who understand the key space layout.
	// Use sparingly.
	PutRaw(key StorageKey, value []byte) error
...
// or ClearIterMVCCRangeAndIntents.
